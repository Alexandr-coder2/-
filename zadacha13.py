#ставшие от необычно теплой зимы, жители решили узнать, 
...
#Output: 2
#Petr Lysikov: А в чем последовательность температур будет хранится? Массив?
...
for i in range(n):
    ...
    if countMax == 0 or count > countMax:
        countMax = count
        count = 0
